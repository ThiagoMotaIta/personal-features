      ...
      <div class="row">
        <div class="col-md-6 align-self-center">
          <div class="left-content">
            ...
            <h4><small>Prêmio Máximo</small> <none class="badge bg-primary">R$ <?php echo number_format($rsC['gift_value'], 2, ',', '.');?></none><br/><small><small>Taxa: R$ <?php echo number_format($rsC['subscription_value'], 2, ',', '.');?></small></small></h4>
            ...
            <p align="left">
              ...
              if ($rsC['solo_or_team'] == "S"){ ?>
                ...
                <br/><br/>
                <small>
                      <strong class="hSection">SLOT</strong>:<br/>
                    <a href="detalhes-grupos.php?camp=<?=$rsC['id']?>" class="btn btn-warning btn-sm"><strong>Consultar SLOT</strong></a>
                  ...
                  <?php if ($rsC['solo_or_team'] == "S" && $rsC['room_game_link'] != NULL /*&& $rsPg['sorted_group'] == ''*/ && $rsPg['final_stage'] == 'F' ){ ?>
                   <br/><br/>
              ...
              if ($rsC['solo_or_team'] == "T"){ 
                ...
                <?php if ($rsC['solo_or_team'] == "T" && $rsC['room_game_link'] != NULL && $rsPg['sorted_group'] == '' /*&& ($qualTimePlayer == '' || $qualTimePlayer == '')*/ /*&& $rsPg['final_stage'] == 'F'*/ ){ ?>
                   <br/><br/>
                  <strong class="hSection">SALA</strong>:<br/>
                  <a href="<?=$rsC['room_game_link']?>" target="_Blank" class="btn btn-warning btn-lg">
                    <strong>LINK DA SALA</strong>
                ...
                ?>    
                  ...
                  <?php } else { ?>
                    ...
                    <?php if ($rsC['current_status'] == "A"){ ?>
                      <button class="btn btn-danger" style="margin:10px;" disabled="disabled"><strong>ESGOTADO</strong></button>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <big><strong><?=$rsC['title']?></strong></big>
           ...
           Início: <?php echo date("d/m/Y", strtotime($rsC['starts_at']));?> às <?=$rsC['starts_at_time']?>
