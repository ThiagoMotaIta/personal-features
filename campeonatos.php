      ...
      <div class="row">
        <div class="col-md-6 align-self-center">
          <div class="left-content">
            ...
            <p align="justify">
              Aqui, você encontra todos os campeonatos disponíveis em nossa plataforma.
              <br/><br/>
              <strong class="hSection">O MELHOR DE TUDO</strong>: Participando dos Campeonatos, você acumula Pontos de Experiência e $NPs (a moeda virtual da plataforma NEXT PLAYER). Dahora, não?!
            </p>
            ...
            <div align="center" class="row">
              ...
              <?php // Lista os Campeonatos
              $q=  mysqli_query($bd, "SELECT * FROM n_championship_p where status = 'A' and listed = 1 and current_status = 'P' order by id desc ");
            ...
            <div align="center" class="row">
              ...
              <?php // Lista os Campeonatos
              $q=  mysqli_query($bd, "SELECT * FROM n_championship_p where status = 'A' and listed = 1 and current_status = 'F' order by id desc ");
            ...
            <!--<p>
              <hr/>
                <a href="campeonatos-detalhes.php?id=13" class="btn btn-warning btn-sm"><i class="fa fa-plus-circle"></i> <strong>CAMPEONATO THE LEGENDS</strong></a>
            </p>-->
