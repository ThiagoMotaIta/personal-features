...
<body>
  ...
  <?php if(!isset($_GET['player'])){ redirect("./"); }?>
      ...
      <div class="row">
        <div class="col-md-6 align-self-center">
          <div class="left-content">
            <h4>Opa, <em><?=$_GET['player']?></em></h4>
            <p align="justify">
              Você já possui uma conta na <strong>NEXT PLAYER</strong>. Para continuar, você precisa fazer login clicando no botão abaixo:
            </p>

            <p>
              <button class="btn btn-warning" onclick="chamaModalLoginJaCadastrado('<?=$_GET['email']?>')"><strong>ENTRAR</strong></button>
            </p>
          </div>
        </div>
        <div class="col-md-6">
          <article class="video-item">
            ...
            <figure>
              <img src="assets/images/freefire-frame.jpg" width="50%">
            </figure>
            <br/>
          </article>
        </div>
