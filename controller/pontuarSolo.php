...
if( isset($_GET['ativo']) && isset($_GET['points']) && isset($_GET['camp']) ){
	...
	if ($rsO['player_id_owner'] == $_SESSION['loggedId']){
		...
		// Atualiza pontuacao FASE GRUPOS
		$sqlUp = "UPDATE n_championship_groups_p SET sorted_group_points = '".$_GET['points']."' WHERE player_id='".$_GET['ativo']."' and championship_id = '".$_GET['camp']."' ";
