...
if( isset($_GET['ativo']) && isset($_GET['points']) && isset($_GET['kills']) && isset($_GET['camp']) ){
	...
	if ($rsO['player_id_owner'] == $_SESSION['loggedId']){
		...
		$sqlUp = "UPDATE n_championship_groups_p SET final_stage_points = '".$_GET['points']."', final_stage_kills = '".$_GET['kills']."' WHERE player_id='".$_GET['ativo']."' and final_stage = 'F' and championship_id = '".$_GET['camp']."' ";
