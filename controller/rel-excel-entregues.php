<?php
 ...
 header("Content-Disposition: attachment; filename=relatorio-app-tablet-entregue-caucaia-ta-on.xls");
...
<table class="table table-striped">
    ...
    // Lista solicitacoes
    $qSol=  mysqli_query($bd, "SELECT * FROM a_solicitacoes_e where status = 'A' and situacao_tablet = '3' order by id desc ");
