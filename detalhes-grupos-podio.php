      ...
      <div class="row">
        <div class="col-md-12 align-self-center">
          <div class="left-content">
            ...
            <?php if($_SESSION["loggedId"] == $rsO['player_id_owner']){?>
              <a class="btn btn-primary" href="detalhes-grupos-podio.php?camp=<?=$rsC['id']?>"><strong>ATUALIZAR CLASSIFICAÇÃO</strong></a>
            <?php } ?>  

            </h4>
            <p align="justify">
              Aqui você encontra a classificação final do <?=$camp?> <strong class="hSection"><?=$rsC['title']?></strong>, organizado por <strong class="hSection"><?=$rsO['organization']?></strong>
            </p>
        ...
        <?php 
              ...
              if ($rsC['solo_or_team'] == 'S'){ ?>
                ...
                <div class="col-md-12 alert alert-info" style="margin-top: 10px;">
                  <h4 class="hSection"><strong>CLASSIFICAÇÃO FINAL</strong></h4>
                  <br/>
                  ...
                  <?php // Lista GRUPO A
                  $iA = 1;
                  $qGPA=  mysqli_query($bd, "SELECT * FROM n_championship_groups_p where status = 'A' and championship_id = '".$rsC['id']."' and final_stage =  'F' order by final_stage_points desc");
                  ...
                  <tr>
                    ...
                    <td><?=$rGPA['final_stage_kills']?></td>
                    <td><?=$rGPA['final_stage_points']?></td> 
                  </tr>
