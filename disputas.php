  ...
  <section class="section video" data-section="section5">
    <div class="container">
      ...
      <div class="row hSection">
        <h3><img src="assets/images/iconeNormal.fw.png" height="30" /> <strong>ARENA</strong><hr/></h3>
      </div>
      ...
      <div class="row">
        <div class="col-md-6 align-self-center">
          <div class="left-content">
            ...
            <p align="justify">
              Aqui, você poderá desafiar qualquer player cadastrado na plataforma NEXT PLAYER, na modalidade X1. Além disso, se você fizer parte de um time, poderá também desafiar os outros times cadastrados na plataforma.
              <br/><br/>
              <strong class="hSection">O MELHOR DE TUDO</strong>: Vencendo as disputas, você acumula Pontos de Experiência e $NPs (a moeda virtual da plataforma NEXT PLAYER). Dahora, não?!
            </p>
        ...
        <div class="col-md-6">
          <article class="video-item">
            ...
            <figure>
              <img src="assets/images/disputas-frame3.jpg" width="50%">
            </figure>
            <br/>
          </article>
        </div>
