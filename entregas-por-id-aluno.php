        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <p align="right">
                        <a href="entregas.php" class="btn btn-primary">Buscar por <strong>CPF RESPONSÁVEL</strong></a>
                    </p>
                    ...
                    <div class="row">
                        <form>
                            <label>Informe o <strong>IDENTIFICADOR DO ALUNO</strong></label>
                            <div class="form-group">
                                <input type="text" class="form-control" id="idAluno" data-mask="000000000000">
                            </div>
                            <button type="button" class="btn btn-primary" onclick="pesquisaTabletRecebido()">Pesquisar</button> <small style="display: none;" id="loading-tuplas"><i class='fa fa-spinner fa-spin'></i> Carregando...</small>
                        </form>
                    </div>
                    ...
                    <table class="table table-striped" id="listaSol">
                        ...
                        $qS1 = mysqli_query($bd, "SELECT * from a_solicitacoes_e where aluno_matricula = '".$_GET['idAluno']."' and status = 'A' ");
                        $rsSol = mysqli_fetch_assoc($qS1);

                        if ($rsSol == null){ ?>
                            <tr>
                            <td colspan="8"><span class="text-danger"><strong><i class="fa fa-exclamation-triangle"></i> ERRO</strong>: Não há solicitações cadastradas para o IDENTIFICADOR <strong><?=$_GET['idAluno']?></strong>.</span></td>
                        </tr>
                        <?php } else {
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form id="form-edit-sol-admin-<?=$rsSol['id']?>" method="post" action="edit-sol-admin-por-id-aluno.php?idSol=<?=$rsSol['id']?>">
...
<script type="text/javascript">
    ...
    function pesquisaTabletRecebido(){
        ...
        if ($("#idAluno").val() == "" || $("#idAluno").val().length < 12){
            validado = false;   
        }

        if (validado){
            window.location.href = "entregas-por-id-aluno.php?idAluno="+$("#idAluno").val();
        } else {
            $.notify({
                icon: "nc-icon nc-chat-round",
                message: "<strong>IDENTIFICADOR</strong> inválido"
