  ...
  <section class="section video" data-section="section5">
    <div class="container">
      ...
      <div class="row" style="color:#fff;">
        ...
        $qCs=  mysqli_query($bd, "SELECT * FROM n_championship_groups_p where status = 'A' and championship_id = 30 /*and final_stage = 'F'*/ order by id ");

        $count = 1;
        while ($rsCs = mysqli_fetch_array($qCs)){

            // Dados jogadores
            $qP1 = mysqli_query($bd, "SELECT * from n_player_p where id = '".$rsCs['player_id']."' and status = 'A' ");
