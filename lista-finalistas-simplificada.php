      ...
      <div class="row">
        <div class="col-md-12 align-self-center">
          <div class="left-content">
            ...
            <p align="justify">
              Aqui você encontra os FINALISTAS do campeonato <strong class="hSection"><?=$rsC['title']?></strong>, organizado por <strong class="hSection"><?=$rsO['organization']?></strong>
            </p>
          </div>
        </div>
      </div>
        ...
        <?php 
              ...
              if ($rsC['solo_or_team'] == 'S'){ ?>
                ...
                <div class="col-md-12 alert alert-info" style="margin-top: 10px;">
                 ...
                 <none class="badge bg-primary" style="color: #fff;">SLOT <?=$iA?></none> | 
