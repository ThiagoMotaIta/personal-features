  ...
  <section class="section video" data-section="section5">
    <div class="container">
      ...
      <div class="row hSection">
        <h3><img src="assets/images/iconeNormal.fw.png" height="30" /> <strong>LOJA</strong><hr/></h3>
      </div>
      ...
      <div class="row">
        <div class="col-md-6 align-self-center">
          <div class="left-content">
            ...
            <p align="justify">
              Aqui, você poderá trocar as suas $NP (nossa moeda virtual) em produtos, serviços, inscrições em campeonatos com taxa e muito mais...
            </p>
        ...
        <div class="col-md-6">
          <article class="video-item">
            <div class="video-caption">
              <h4>Isso sim é vantagem!</h4>
            </div>
            <figure>
              <img src="assets/images/loja-frame.jpg" width="50%">
            </figure>
            <br/>
          </article>
        </div>
