...
<body>
  ...
  <!-- Verifica se hash ta ok -->
  <?php if(!isset($_GET['hash'])){ redirect("./"); }?>
  ...
  $qP = mysqli_query($bd, "SELECT * from n_player_p where user_hash = '".$_GET['hash']."' and status = 'A'" );
  $rsP = mysqli_fetch_assoc($qP);

  if ($rsP == NULL){ redirect("./"); }
      ...
      <div class="row">
        <div class="col-md-6 align-self-center">
          <div class="left-content">
            <h4>Olá, <strong class="hSection"><?=$rsP['name']?></strong>!</h4>
            <p align="justify">
            ...
            <p>
              <div class="form-group">
                <input type="password" id="newPassWord" class="form-control" placeholder="Informe a Nova Senha">
                <small id="msnErroNewPassWord" style="display: none" class="text-danger">Informe a Nova Senha</small>
              </div>
              <div class="form-group">
                <input type="password" id="newPassWordConfirm" class="form-control" placeholder="Confirme a Nova Senha">
                <small id="msnErroNewPassWordConfirm" style="display: none" class="text-danger">Confirme a Nova Senha</small>
              </div>
            </p>

            <p id="msnRetornoNewPass" style="display: none;"></p>

            <p>
              <button class="btn btn-warning btn-sm" id="btnRecAcessoNewPass"
              onclick="recuperarAcessoNovaSenha('<?=$rsP['user_hash']?>')"><strong>CRIAR NOVA SENHA</strong></button>
              <div id="loadingRecuperarNewPassWord" style="display: none;"><br/><i class="fa fa-spinner fa-spin"></i> Carregando...</div>
            </p>
