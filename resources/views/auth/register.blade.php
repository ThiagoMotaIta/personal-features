                    ...
                    <div class="row g-0">
                      <div class="col-lg-6">
                        <div class="card-body p-md-5 mx-md-4">
                          ...
                          <div class="text-center">
                            ...
                            <h4 class="mt-1 mb-5 pb-1">CRIAR CONTA VENDEDOR</h4>
                          </div>
                          ...
                          <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="d-flex align-items-center justify-content-center pb-4">
                              ...
                              <a class="btn btn-outline-danger" href="login"><i class="fa fa-sign-in"></i> Entrar</a>
                            </div>
                      ...
                      <div class="col-lg-6 d-flex align-items-center alert-primary">
                        <div class="text-primary px-3 py-4 p-md-5 mx-md-4">
                          ...
                          <p class="small mb-0">Este é o portal de oportunidades de vendas da <strong>VITAMINAWEB</strong>. Crie sua conta de vendedor. É super simples!</p>
                          <br/>
