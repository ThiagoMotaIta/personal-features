    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12 align-self-center">
          <div class="left-content">
            ...
            <p align="justify">
              Aqui você encontra todos os times criados pelos players, em nossa plataforma:
            </p>

            <p>
              <hr/>
              <a href="campeonatos.php" class="btn btn-warning btn-sm"><i class="fa fa-search"></i> <strong>BUSCAR TIME</strong></a>
            </p>
      ...
      <div class="row" style="color:#fff;">
        <?php 
              ...
              // Lista Times
              $qT=  mysqli_query($bd, "SELECT * FROM n_team_p where status = 'A' order by team ");
              while ($rsT = mysqli_fetch_array($qT)){ 

                // Verifica se tem membro
                $qTf = mysqli_query($bd, "SELECT team_id from n_team_formation_p where team_id = '".$rsT['id']."' and status = 'A' ");
                $rsTf = mysqli_fetch_assoc($qTf);

                if ($rsTf != NULL){ 

                  // Game
                  $qG = mysqli_query($bd, "SELECT game from n_games_p where id = '".$rsT['game_id']."' and status = 'A' ");
                  $rsG = mysqli_fetch_assoc($qG);

                  ?>

                <div class="col-md-3 alert" align="center">
                  <a href="time-perfil.php?time=<?=$rsT['id']?>">
                  <img width="100" src="teams/<?=$rsT['logo']?>" class="img img-thumbnail" /><br/>
                  <strong><?=$rsT['team']?></strong>
                  <br/>
                  <small><?=$rsG['game']?></small>                  
                  </a>
                </div>
