...
<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center">
        <ul class="navbar-nav navbar-nav-left">
          <li class="nav-item">
            <span id="carregandoPagina"><i class="fa fa-spinner fa-pulse fa-3x"></i></span>
          </li>
        </ul>
          ...
          <li class="nav-item dropdown d-none d-xl-inline-block">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <a class="dropdown-item mt-2" href="javascript:void(0);" data-toggle="modal" data-target="#modalMudarSenha">
                <i class="fa fa-user"></i> Editar Senha
              </a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header alert-primary">
          <h4 class="modal-title" id="exampleModalLabel"><i class="fa fa-lock"></i> Alterar Senha</h4>
