...
<section class="section contact" data-section="section6">
  <div class="container">
    <div class="row">
      ...
      <!-- Entre em contato -->                    
        <form id="contact" action="" method="post">
          <div class="row">
            ...
            <div class="col-md-12">
              <fieldset>
                <button type="submit" id="form-submit" class="button">Deixe seu recado</button>
              </fieldset>
            </div>
          </div>
        </form>
      ...
      <div class="col-md-6">
        <div id="map">
          <iframe src="https://maps.google.com/maps?q=Av.+Dioguinho,+Fortaleza+-+CE,+Brazil&t=&z=13&ie=UTF8&iwloc=&output=embed" width="100%" height="422px" frameborder="0" style="border:0" allowfullscreen></iframe>
        </div>
      </div>
    </div>
  </div>
